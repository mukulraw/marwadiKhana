...
public interface allAPIs {
    ...
    Call<codBean> cod(@Part("entityid") String entityId , @Part("userid") String userId , @Part("order_id") String orderId , @Part("billing_name") String billingName , @Part("billing_lastname") String billingLastName , @Part("billing_address") String billingAddress , @Part("billing_city") String billingCity , @Part("billing_state") String billingState , @Part("billing_zip") String billingZip , @Part("billing_country") String billingCountry , @Part("billing_email") String billingEmail , @Part("dilivery_name") String deliveryName , @Part("dilivery_address") String deliveryAddress , @Part("dilivery_city") String deliveryCity , @Part("dilivery_state") String deliveryState , @Part("dilivery_zip") String deliveryZip , @Part("dilivery_country") String deliveryCountry , @Part("type") String type , @Part("amount") String amount);
}